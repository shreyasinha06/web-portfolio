...
<div class="container">
	<div class="collapse"  id="home">
	  <div class="p-5 text-white bg-info">
		<h2><i class="fa fa-heartbeat" aria-hidden="true">Computer Language Proficiency</i></h2>
      ...
      <div class="card-footer"> Date: 2014-2015 </div>
	 		...
	 		<div class="card">
	 			...
	 			<div class="card-body">
	 				...
	 				<p class="bg-danger text-white p-2 ">Btech</p>
	 				<p class="bg-danger text-white p-2">Second Year Information Technology</p>
	 			</div>
	 			...
	 			<form>
	 				<div class="form-group">
	 					<div class="input-group input-group-lg">
	 						<span class="input-group-addon bg-warning text-white p-2"><i class="fa fa-user"> </i></span>
	 						<input type="text" name="" class="form-control bg-dark text-white" placeholder="Username">
	 					</div>
	 				</div>
	 				<div class="form-group">
	 					<div class="input-group input-group-lg">
	 						<span class="input-group-addon bg-warning text-white p-2"><i class="fa fa-envelope"> </i></span>
...
<div class="collapse" id="work">
	<div class="p-5 text-white bg-success font-italics">
		<h2 class="mb-2"><i class="fa fa-line-chart" mb-"3" aria-hidden="true" "p-2">My Portfolio</i></h2>
		<p><i>~"YOUR I CAN IS MORE IMPORTNT THAN YOUR IQ"~<i></p>
	 </div>
	<div class="card card-body">
		<h2><i class="fa fa-certificate" >WORKS AND CERTIFICATES</i></h2>
		<p>~amazing artworks and webpages~</p>
		<div class="row no gutters">
			<div class="col-lg-4 col-md-4 order-1"> <a href="C:\Users\MAHE\Desktop/last.html" target="_blank"><img src="C:\Users\MAHE\Desktop/88.jpeg" style="width: 400px; height:400px;"></a></div>
			<div class="col-lg-4 col-md-4 order-2"><a href="C:\Users\MAHE\Desktop/last3.html" target="_blank"><img src="C:\Users\MAHE\Desktop/78.jpeg" style="width: 400px; height:400px;"></a></div>
			<div class="col-lg-4 col-md-4 order-6"><a href="C:\Users\MAHE\Desktop/last3.html" target="_blank"> <img src="C:\Users\MAHE\Desktop/tu.jpeg" style="width: 400px; height:400px;"></a></div>
			<div class="col-lg-4 col-md-4 order-3"> <a href="C:\Users\MAHE\Desktop/last2.html" target="_blank"><img src="C:\Users\MAHE\Desktop/bb.png" style="width: 400px; height:400px;"></a></div>
			<div class="col-lg-4 col-md-4 order-4"> <a href="C:\Users\MAHE\Desktop/last2.html" target="_blank"><img src="C:\Users\MAHE\Desktop/57.png" style="width: 400px; height:400px;"></a></div>
			<div class="col-lg-4 col-md-4 order-5"> <a href="C:\Users\MAHE\Desktop/last2.html" target="_blank"><img src="C:\Users\MAHE\Desktop/mum.png" style="width: 400px; height:400px;"></a></div>	
	</div>
</div>
</div>
